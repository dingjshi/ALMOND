#' Apply the generalized Bayesian two-stage normal-selection causal model with instrumental variables.
#'
#' @description The \code{gts.nnormal.s} function applies the generalized Bayesian two-stage
